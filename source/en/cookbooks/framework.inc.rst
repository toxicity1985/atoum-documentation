...
.. note::
   For more information about creating Entity in Symfony 2, refer to the `symfony documentation <http://symfony.com/doc/current/doctrine.html#creating-an-entity-class>`_
